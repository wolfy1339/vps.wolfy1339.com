 ...
 */
define('BOOTSTRAP_THEME', 'm8tro-blue');
// Use bootstrap-theme.min.css?
define('USE_BOOTSTRAP_THEME', false);
 ...
 */
define('FONTAWESOME_STYLE','fa-lg');
...
if (CUSTOM_THEME) {
    ...
    if (in_array(BOOTSTRAP_THEME, $bootswatch)) {
        ...
        $bootstrap_cdn = '/Resources/css/'.BOOTSTRAP_THEME.'.min.css';
    } else {
        $bootstrap_cdn = '/Resources/css/bootstrap.min.css';
    }
}
...
$header .= "  <title>Index of ".$_SERVER['REQUEST_URI']."</title>" . PHP_EOL;
...
if (USE_BOOTSTRAP_THEME) {
    $header .= "  <link rel=\"stylesheet\" href=\"/Resources/css/bootstrap-theme.min.css\">". PHP_EOL;
}
$header .= "  <link rel=\"icon\" type=\"image/png\" sizes=\"16x16\" href=\"http://wolfy1339.tk/img/favicon16.png\" />" .PHP_EOL;
$header .= "  <link rel=\"icon\" type=\"image/png\" sizes=\"32x32\" href=\"http://wolfy1339.tk/img/favicon32.png\" />" .PHP_EOL;
$header .= "  <link rel=\"icon\" type=\"image/png\" sizes=\"48x48\" href=\"http://wolfy1339.tk/img/favicon48.png\" />" .PHP_EOL;
$header .= "  <link rel=\"icon\" type=\"image/png\" sizes=\"57x57\" href=\"http://wolfy1339.tk/img/favicon57.png\" />" .PHP_EOL;
$header .= "  <link rel=\"icon\" type=\"image/png\" sizes=\"76x76\" href=\"http://wolfy1339.tk/img/favicon76.png\" />" .PHP_EOL;
$header .= "  <link rel=\"icon\" type=\"image/png\" sizes=\"120x120\" href=\"http://wolfy1339.tk/img/favicon120.png\" />" .PHP_EOL;
$header .= "  <link rel=\"icon\" type=\"image/png\" sizes=\"152x152\" href=\"http://wolfy1339.tk/img/favicon152.png\" />" .PHP_EOL;
$header .= "  <link rel=\"apple-touch-icon\" href=\"http://wolfy1339.tk/img/favicon.png\" />" .PHP_EOL;
$header .= "  <link rel=\"apple-touch-icon\" type=\"image/png\" sizes=\"57x57\" href=\"http://wolfy1339.tk/img/favicon57.png\" />" .PHP_EOL;
$header .= "  <link rel=\"apple-touch-icon\" type=\"image/png\" sizes=\"76x76\" href=\"http://wolfy1339.tk/img/favicon76.png\" />" .PHP_EOL;
$header .= "  <link rel=\"apple-touch-icon\" type=\"image/png\" sizes=\"120x120\" href=\"http://wolfy1339.tk/img/favicon120.png\" />" .PHP_EOL;
$header .= "  <link rel=\"apple-touch-icon\" type=\"image/png\" sizes=\"152x152\" href=\"http://wolfy1339.tk/img/favicon152.png\" />" .PHP_EOL;
$modal_css = null;
if (ENABLE_VIEWER) {
