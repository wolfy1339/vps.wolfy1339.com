...
if (FAV_ICON) $header = $header."  <link rel=\"shortcut icon apple-touch-icon\" type=\"image/png\" sizes=\"16x16\" href=\"".FAV_ICON."\" />" . PHP_EOL;
if (FAV_ICON_32) $header = $header."  <link rel=\"shortcut icon apple-touch-icon\" type=\"image/png\" sizes=\"32x32\" href=\"".FAV_ICON_32."\" />" . PHP_EOL;
if (FAV_ICON_48) $header = $header."  <link rel=\"shortcut icon apple-touch-icon\" type=\"image/png\" sizes=\"48x48\" href=\"".FAV_ICON_48."\" />" . PHP_EOL;
if (FAV_ICON_76) $header = $header."  <link rel=\"shortcut icon apple-touch-icon\" type=\"image/png\" sizes=\"76x76\" href=\"".FAV_ICON_76."\" />" . PHP_EOL;
if (FAV_ICON_120) $header = $header."  <link rel=\"shortcut icon apple-touch-icon\" type=\"image/png\" sizes=\"120x120\" href=\"".FAV_ICON_120."\" />" . PHP_EOL;
if (FAV_ICON_152) $header = $header."  <link rel=\"shortcut icon apple-touch-icon\" type=\"image/png\" sizes=\"16x16\" href=\"".FAV_ICON_32."\" />" . PHP_EOL;
if (IPHONE_ICON) $header = $header."  <link rel=\"shortcut icon apple-touch-icon\" type=\"image/png\" sizes=\"57x57\" href=\"".IPHONE_ICON."\" />" . PHP_EOL;
if (IPHONE_ICON_RETINA) $header = $header."  <link rel=\"shortcut icon apple-touch-icon\" type=\"image/png\" sizes=\"72x72\" href=\"".IPHONE_ICON_RETINA."\" />" . PHP_EOL;
if (IPAD_ICON) $header = $header."  <link rel=\"shortcut icon apple-touch-icon\" type=\"image/png\" sizes=\"114x114\" href=\"".IPAD_ICON."\" />" . PHP_EOL;
if (IPAD_ICON_RETINA) $header = $header."  <link rel=\"shortcut icon apple-touch-icon\" type=\"image/png\" sizes=\"144x144\" href=\"".IPAD_ICON_RETINA."\" />" . PHP_EOL;
...
$footer .= "<script type=\"text/javascript\" src=\"script.js\"></script>" . PHP_EOL;
